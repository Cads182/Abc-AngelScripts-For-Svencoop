...
class weapon_dm357 : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		m_pPlayer.FireBullets( 1, vecSrc, vecAiming, bInZoom ? g_vecZero : VECTOR_CONE_1DEGREES, 8192, BULLET_PLAYER_357, 2 );
		...
		Vector vecDir = vecAiming + x * (bInZoom ? 0 : VECTOR_CONE_1DEGREES.x) * g_Engine.v_right + y * (bInZoom ? 0 : VECTOR_CONE_1DEGREES.y) * g_Engine.v_up;
