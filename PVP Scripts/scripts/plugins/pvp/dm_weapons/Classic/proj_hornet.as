...
const float fl_plrHornet		= g_EngineFuncs.CVarGetFloat( "sk_hornet_pdmg" );
...
class dmhornet : ScriptBaseMonsterEntity
{
	...
	void Spawn()
	{
		...
		SetThink( ThinkFunction( this.StartTrack ) );

		edict_t@ pSoundEnt = pev.owner;
		if ( pSoundEnt is null )
			@pSoundEnt = self.edict();

		pev.dmg = fl_plrHornet;
